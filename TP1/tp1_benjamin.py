...
countBow = CountBoW(PreprocessingPipeline(False, True, True), False, True)
countBow.fit_transform(["coucou1 coucou2 coucou3 coucou1 coucou2 coucou3 coucou1 coucou4 coucou2 coucou5 coucou3 coucou5", "test1 test2 test3 test4 test5"])
...
class TFIDFBoW(object):
    ...
    def find_idf(self, df, N):
        idf = [N] * len(df) 
        idf = [x/y if y != 0 else 1 for x, y in zip(idf, df)]
...
tfidf = TFIDFBoW(PreprocessingPipeline(False, True, True), False, False)
tfidf.fit_transform(["coucou1 coucou2 coucou3 coucou1 coucou2 coucou3 coucou1 coucou4 coucou2 coucou5 coucou3 coucou5", "coucou1 test1 test2 test3 test4 test5", "coucou3 coucou1"])
        
tfidf.transform(["coucou1 ", "coucou1 test1 test2 test3 test4 test5", "coucou3 coucou1"])
